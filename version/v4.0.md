# 🧠 R.E.F. v4.0 — Cogni-Emocional Adaptativa  
...
[![Version](https://img.shields.io/badge/R.E.F.-v4.0-purple.svg)]()

> 🔹 **Versão 4.0** introduz a camada **cogni-emocional adaptativa**,  
...
```yaml
reverse_engineering_framework_v4_0:
...
```bibtex
@manual{ref_v4_0,
  title   = {R.E.F. v4.0 — Cogni-Emotional Adaptive Framework},
  author  = {Mente Integrada Arquetípica},
  year    = {2025},
  note    = {Reverse Engineering Framework v4.0, Open Cognitive Architecture},
...
>
> 🧩 Esta versão 4.0 atua como **ponte entre cognição e emoção funcional**,
